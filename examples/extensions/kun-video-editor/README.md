...
`kun-video-editor-0.4.1.kunx` asset beside the desktop installers and the three
...
```bash
kun extension validate ./kun-video-editor-0.4.1.kunx
kun extension install ./kun-video-editor-0.4.1.kunx
```
