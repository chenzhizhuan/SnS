...
- [x] 1.2 Keep one direct tool-menu entry and independent tab per visible right-sidebar contribution with declared-icon and fallback behavior
...
- [x] 4.3 Verify the bundled video editor in the running app as a direct tool-menu tab beside the main conversation
