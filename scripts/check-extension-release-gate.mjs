...
const packagedVideoReleaseCommand =
  'npm run smoke:packaged-video-editor-native -- --archive dist/kun-video-editor-0.4.2.kunx'
...
requireOrderedSourceMarkers(releaseMacScript, 'scripts/release-mac.sh packaged smoke function', [
  ...
  '--archive "${ROOT}/dist/kun-video-editor-0.4.2.kunx"'
])
for (const marker of [
